        ...
        try {
            ...
            if(osName.startsWith("Windows")){
                ...
                if(bitness == 32){
                    ...
                    in = Main.class.getResourceAsStream("/OpenCVDistrib/x86/opencv_java345.dll");
                    fileOut = File.createTempFile("lib", ".dll");
                }
                else if (bitness == 64){
                    //Utils.out.println(VideoEncodingChecker.class, "64 bit detected");
                    in = Main.class.getResourceAsStream("/OpenCVDistrib/x64/opencv_java345.dll");
                    fileOut = File.createTempFile("lib", ".dll");
                }
                else{
                ...
                in = Main.class.getResourceAsStream("/OpenCVDistrib/mac/libopencv_java345.dylib");
